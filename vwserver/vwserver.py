...
def sleep_until(fn, timeout=25.0):
    ...
    for t in (0.1, 0.2, 0.4, 0.8, 1.6, 3.2, 6.4, 12.8):
        if fn():
            return True
...
class VW(object):
    def __init__(
        self, name, data_dir, vw_binary, log, options=None, on_fatal_failure=None
    ):
